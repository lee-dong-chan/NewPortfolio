      ...
      <div>
        ...
        <div className="pt-[1rem] h-[40rem]">
          ...
          <div>
            ...
            {maketext === 1 &&
              ProjectData.page2?.make.text.map((item: string, idx: number) => (
                <div key={idx}>
                  <div className="p-1">
                    <span className="px-1">-</span>
                    {item}
            ...
            {maketext === 2 &&
              ProjectData.page3?.make.text.map((item: string, idx: number) => (
                <div key={idx}>
                  <div className="p-1">
                    <span className="px-1">-</span>
                    {item}
